            ...
            <aside className="w-80 bg-white border-r p-6 space-y-8">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <button
                            className={`block w-full text-left px-3 py-2 rounded ${activeSection === "details" ? "bg-black text-white" : "bg-gray-100"
                                }`}
                        ...
                        <button
                            className={`block w-full text-left px-3 py-2 rounded ${activeSection === "fields" ? "bg-black text-white" : "bg-gray-100"
                                }`}
                        ...
                        <button
                            className={`block w-full text-left px-3 py-2 rounded ${activeSection === "layouts" ? "bg-black text-white" : "bg-gray-100"
                                }`}

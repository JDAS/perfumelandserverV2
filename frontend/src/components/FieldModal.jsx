                ...
                <form onSubmit={handleSubmit} className="space-y-4 px-6 py-5">
                        ...
                        <select
                            ...
                            onChange={(e) => {
                                ...
                                setField({
                                    ...field,
                                    type: nextType,
                                    required: nextType === "formula" ? false : field.required,
                    ...
                    {field.type === "formula" && (
                        <div className="space-y-4">
                            <div>
                                <label className="mb-1 block text-sm font-medium">Expresión</label>
                                <input
                                    className="w-full rounded border p-2"
                            ...
                            <div>
                                <label className="mb-1 block text-sm font-medium">Tipo de retorno</label>
                                <select
                                    className="w-full rounded border p-2"

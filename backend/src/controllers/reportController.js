...
exports.runReport = async (req, res) => {
  ...
  } else if (report.engine === "seller_campaign_performance") {
    data = await executeSellerCampaignPerformanceReport(report, req.query || {});
  } else if (report.engine === "cash_profitability") {
